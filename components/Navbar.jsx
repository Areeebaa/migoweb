...
//                                 scrolled ? 'text-migo-dark' : 'text-white'
//                             }`}
//                         >
//                             MIGO
//                         </span>
...
//                             // className="text-migo-lavender/90 hover:text-migo-white font-medium text-sm transition-colors duration-200"
    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <a href="#" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-migo-dark flex items-center justify-center border border-migo-lavender/30">
              <span className="text-migo-lavender font-black text-sm tracking-wider">
                M
              </span>
            </div>
